...
└── stages/
    ...
    ├── 02-catalogo/        inventario + taxonomia dos cursos (165+65)
...
| Inventariar e classificar os cursos | `stages/02-catalogo/CONTEXT.md` |
...
| Catalogo | `stages/01-descoberta/output/`, `stages/02-catalogo/references/cursos-fonte.md` | `design-system/`, `skills/`, estagios 03 a 06 |
| Design/UX | `stages/02-catalogo/output/`, `stages/03-design-ux/references/*`, `design-system/*`, `skills/` (frontend) | estagios 04 a 06, transcricao |
